 ...
 * @author Arseniy
 */
public class ChooseOrDoesNotNeedRepairingDialog extends javax.swing.JDialog {

    /**
     * Creates new form youNeedToChooseItemDialog
     */
    public ChooseOrDoesNotNeedRepairingDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        warningLabel1.setFont(new java.awt.Font("Castellar", 0, 14)); // NOI18N
        warningLabel1.setForeground(new java.awt.Color(204, 204, 204));
        warningLabel1.setText("Or item does not need to be repaired!");
